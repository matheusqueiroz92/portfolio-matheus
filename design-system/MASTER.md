...
**Project:** Portfolio Matheus
**Generated:** 2026-06-27 06:54:05
...
> **Override:** Este repositório já implementa identidade editorial com **Geist Sans/Mono**,
> paleta warm cream (`--background: #f7f3ea` light / `#0a0a0a` dark) e azul sóbrio
> (`--primary: #1d4ed8` light / `#60a5fa` dark). Priorize os tokens em `src/app/globals.css`
> sobre as cores genéricas deste MASTER quando houver conflito.
